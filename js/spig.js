...
jQuery(document).ready(function ($) {
    $("#spig").mousedown(function (e) {
        if(e.which==3){
        showMessage("秘密通道:<br /><a href=\"http://feed.feedsky.com/zscorpio/\" title=\"订阅\">订阅</a>    <a href=\"http://feed.feedsky.com\" title=\"首页\">首页</a>",10000);
}
});
...
jQuery(document).ready(function ($) {
    if (isindex) { //如果是主页
        ...
        showMessage('欢迎' + visitor + '来到蝎紫の博客阅读《' + title + '》', 6000);
    }
    $(".spig").animate({
